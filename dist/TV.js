...
const vivax = document.getElementById('vivax');
const favorit = document.getElementById('favorit');
const NEO = document.getElementById('neo');
const JVC = document.getElementById('jvc');
const philips = document.getElementById('philips');
...
function test() {
    return __awaiter(this, void 0, void 0, function* () {
        yield fetch('/data/scraped_products.json')
